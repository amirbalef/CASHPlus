...
def train_lcpfn(
    ...
    if(custom_bar_distribution!=None):
        bar_distribution = custom_bar_distribution
    ...
    config = dict(
        ...
        checkpoint_file="lcpfn/trained_models/" + "my_pfn.pt",
        num_outputs = num_outputs,
        decoder=lambda ninp, nhid, n_out: nn.Sequential(
            nn.Linear(ninp, nhid),
            GELU(),
